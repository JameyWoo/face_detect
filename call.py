...
with open('./currentFile.txt', 'r') as file:
    txt = file.read()
detech_img_url = 'http://wujiahao.online/jamey/face/upload/' + txt
# print("detech_img_url = ", detech_img_url)

# 以下四项是dmeo中用到的图片资源，可根据需要替换
# detech_img_url = 'https://img.ivsky.com/img/tupian/pre/201810/16/lifashi-004.jpg'
